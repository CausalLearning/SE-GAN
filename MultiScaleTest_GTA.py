...
def get_arguments():
    ...
    parser.add_argument("--restore-from", type=str, default='/home/yonghao.xu/PreTrainedModel/GTA2Cityscapes_batch_4000_miou_495.pth',
                        help="restored model.")   
    parser.add_argument("--snapshot_dir", type=str, default='./Result/GTA/',
...
def main():
    ...
    f = open(args.snapshot_dir+'MultiScaleTest_GTA.txt', 'w')
