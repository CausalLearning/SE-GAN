...
def get_arguments():
    ...
    parser.add_argument("--original_size", type=str, default='1280,760',
    ...
    parser.add_argument("--restore_from", type=str, default='/home/yonghao.xu/PreTrainedModel/SynthiaTrans_epoch_5_batch_4700_miou_56.pth',
...
def main():
    ...
    snapshot_dir = args.snapshot_dir+'Synthia/images/'
