...
def get_arguments():
    ...
    parser.add_argument("--restore-from", type=str, default='/home/yonghao.xu/PreTrainedModel/Synthia2Cityscapes_batch_24500_miou_450.pth',
                        help="restored model.")   
    parser.add_argument("--snapshot_dir", type=str, default='./Maps/Synthia/',
...
def main():
    ...
    for index, batch in enumerate(testloader):
        ...
        output2city = output.copy()
        output2city[output>8] += 1
        output2city[output>12] += 1
        output2city[output>13] += 1

        output_col = colorize_mask(output2city)
        name = name[0].split('/')[-1]
