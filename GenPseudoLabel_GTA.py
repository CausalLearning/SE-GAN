...
def get_arguments():
    ...
    parser.add_argument("--restore-from", type=str, default='/home/yonghao.xu/PreTrainedModel/GTA2Cityscapes_batch_40500_miou_485.pth',
                        help="restored model.")   
    parser.add_argument("--snapshot_dir", type=str, default='./PseudoLabel/GTA/adv1e3/',
...
def main():
    ...
    f = open(args.snapshot_dir+'GenPseudoLabel_GTA.txt', 'w')
    cudnn.enabled = True
    ...
    model.eval()
    model.cuda()
    testloader = data.DataLoader(cityscapesDataSet(args.data_dir, args.data_list, crop_size=(1024, 512), mean=IMG_MEAN, scale=False, mirror=False, set='train'),
